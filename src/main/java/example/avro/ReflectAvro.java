...
public class ReflectAvro {
	...
	public static void main(String[] args) throws Exception {
		...
		DatumWriter<Packet> writer = new ReflectDatumWriter<Packet>(
				Packet.class);
		DataFileWriter<Packet> out = new DataFileWriter<Packet>(writer)
				.setCodec(CodecFactory.deflateCodec(9)).create(schema, file);
		...
		DatumReader<Packet> reader = new ReflectDatumReader<Packet>(
				Packet.class);
